...
Repositorio personal de aprendizaje de la especialización **[Excel Skills for Business](https://www.coursera.org/specializations/excel)** (Macquarie University, Coursera Plus).

Ver el temario completo en [SYLLABUS.md](SYLLABUS.md).
...
- [Chuleta de fórmulas](recursos/formulas-cheatsheet.md)
- [Glosario](recursos/glosario.md)
- [Atajos de teclado](recursos/atajos-teclado.md)
